...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		scoreText.setFormat(Paths.font("Dark Future Italic.ttf"), 32, FlxColor.WHITE, RIGHT);
		...
		text.setFormat(Paths.font("Dark Future Italic.ttf"), size, FlxColor.WHITE, RIGHT);
